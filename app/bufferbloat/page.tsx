  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-16">
      <header className="mb-12 text-center animate-fade-up" style={{ animationDelay: "0ms" }}>
        <h1 className="text-4xl font-bold tracking-tight text-[#ededed]">Bufferbloat Test</h1>
        <p className="mx-auto mt-3 max-w-lg text-[#888888]">
          Network Performance Analysis with Real-Time Measurements
        </p>
        <p className="mx-auto mt-2 max-w-xl text-xs text-[#555555]">
      ...
      <section
        className="mt-12 rounded-lg border border-[#1a1a1a] bg-[#0a0a0a] p-6 animate-fade-up"
      ...
      >
        ...
        <h3 className="mb-2 text-sm font-medium text-[#ededed]">Test Phases</h3>
        <ol className="mb-6 list-inside list-decimal space-y-1 text-sm text-[#888888]">
          <li><strong className="text-[#ededed]">Baseline</strong> &mdash; Measures idle latency</li>
          <li><strong className="text-[#ededed]">Download</strong> &mdash; Measures latency during download</li>
          <li><strong className="text-[#ededed]">Upload</strong> &mdash; Measures latency during upload</li>
        </ol>

        <h3 className="mb-3 text-sm font-medium text-[#ededed]">Grading Scale</h3>
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-6">
          {[
            ...
            <div
              key={grade}
              className="rounded-lg bg-[#111111] px-3 py-2 text-center"
            >
              <div className={`text-lg font-bold ${color}`}>{grade}</div>
              <div className="text-xs text-[#555555]">{range}</div>
            </div>
          ))}
        </div>
      </section>
